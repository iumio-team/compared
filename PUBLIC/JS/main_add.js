$(document).ready(function(){
   ...
   $('.remove_user').each(function(){
    ...
    $(".PIN").find("img.btn").each(function(){
                              ...
                              if(modd == "OFF"){
                                   $('#modalCP').find(".message").text("Désactivation du comparateur ...");
                                    ...
                                    $('#modalCP').find(".message").text("Activation du comparateur ...");
                                     ...
                                     var timerChangePage = setInterval(function(){
                                         clearInterval(timerChangePage);
                                         window.location = 'Wui.php?run=getInfoComparator&argument=void';
      ...
      $('#maintenance').each(function(){
         $(this).bind('click',function(e){
            e.preventDefault();
            request = $.ajax({
              url: "Wui.php?run=getMaintenanceStatus&argument=void",
              type: "POST",
              dataType: "html",
    ...
    $('.deleteMessageValidate').bind('click',function(e){
            ...
            var reqSrc = $(this).attr("data");
            request = $.ajax({
              url: "Wui.php?run=deleteMessage&argument="+""+reqSrc,
              type: "POST",
              dataType: "html",
              ...
              success : function(_data){
                 if(_data === '1'){
                    ...
                    clearInterval(timerChangePage);
                    window.location = 'Wui.php?run=getMessages&argument=void';
