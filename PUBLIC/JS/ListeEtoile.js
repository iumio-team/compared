...
function CreateListeEtoile(idListe, nbEtoile){
	...
	for(i=1; i<=nbEtoile; i++){
		...
		renduListe += "<img id=\"staroff-" + idListe + "-" + i + "\" src=\"PUBLIC/IMAGE/staroff.gif\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: block;\">";
		renduListe += "<img id=\"staron-" + idListe + "-" + i + "\" src=\"PUBLIC/IMAGE/staron.gif\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: none;\">";
		renduListe += "</a>";
		renduListe += "</li>";
	}
