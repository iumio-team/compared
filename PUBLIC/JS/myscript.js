...
jQuery(document).ready(function(){
    ...
    function resetPie(_percent, _color){
        ...
        if (chart.length) {
            ...
            chart.each(function () {
                $(this).data('easyPieChart').options.barColor = _color;
    ...
    $('.rounded').each(function(){
        $(this).bind('click',function(e){
            e.preventDefault();
            if($(this).find('.blueColor')){
                 $(this).removeClass('blueColor'); 
                 console.log('YES BLUE')
            }
            
            if($(this).find('.redColor')) {
                $(this).removeClass('redColor'); console.log('YES RED')
                
            }
            var reqSrc = $(this).attr('data-percent');
            ...
            if(reqSrc > 0){
                ...
                resetPie(- parseInt(reqSrc), globalColor);
                ...
                $('.icon-arrow-left').attr('class','icon-arrow-right');
         ...
         $.ajax({
                ...
                success: function(_data){
                    ...
                    $('#good').html("Un problème est survenue lors de l'envoi de votre message . Merci de réessayer .");
                     ...
                     $('#form_help').find('input.name').val("");
                      $('#form_help').find('input.subject').val("");
                       $('#form_help').find('textarea.content').val("");
                        $('#form_help').find('input.email').val("");
