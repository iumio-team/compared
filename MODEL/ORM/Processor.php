...
class Processor implements ORM {
   ...
   public function create() {
        parent::create();
        $count = (new Model())->insertProcessor($this->idP,$this->namingP,$this->constructorP,$this->nbOfCoreP,$this->frenquencyP,$this->archP,$this->versionP)->rowCount();
        return $count;
    }

    public function delete() {
        parent::delete();
        $count = (new Model())->deleteAllById('Processor', $this->idP, 'idP')->rowCount();
        return $count;
    }

    public function update() {
        parent::update();
        $count = (new Model())->updateProcessor($this->idP,$this->namingP,$this->nbOfCoreP,$this->frenquencyP,$this->archP,$this->versionP)->rowCount();
        return $count;
    }

    public function getItem(){
        $result = (new Model())->findAllById('Processor',$this->idP,'idProc')->fetch();
