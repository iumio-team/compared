...
class MarkdownDocument  {
	 ...
	 */
	public static function createFromStream ($markdown_stream, $flags) {}

	/**
	 * @param markdown_doc
	 * @param flags[optional]
	 */
	public static function createFromString ($markdown_doc, $flags) {}

	/**
	 * @param markdown_stream
	 * @param flags[optional]
	 */
	final protected function initFromStream ($markdown_stream, $flags) {}

	/**
	 * @param markdown_doc
	 * @param flags[optional]
	 */
	final protected function initFromString ($markdown_doc, $flags) {}
	 ...
	 * @param flags[optional]
	 */
	public static function transformFragment ($markdown_fragment, $flags) {}
	 ...
	 * @param flags[optional]
	 */
	public static function writeFragment ($markdown_fragment, $out_stream, $flags) {}
