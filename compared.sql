...
--
-- Client: localhost
-- Généré le: Jeu 07 Mai 2015 à 14:23
...
CREATE TABLE IF NOT EXISTS `GPU` (
  ...
  `gflops` decimal(4,1) NOT NULL,
  `print` int(11) NOT NULL,
  `directXV` decimal(4,1) NOT NULL,
  PRIMARY KEY (`idG`)
...
(1, 'SM-N916L', 'Galaxy Note 4', 'Samsung', 3, 176, 8.5, 78.6, 153.5, '2014-10-17', 729, 3.7, 16, '32', '128', 3220, '2G/3G/3G+/4G(LTE)/4G+', 'HD 1080p (1920*1080)', '3840x2160 ', 'samsunggalaxynote4', 2, 6, 2, 2, '2015-02-03', '', ''),
(2, 'SM-N9005', 'Galaxy Note 3', 'Samsung', 3, 168, 8.3, 79.2, 151.2, '2013-09-12', NULL, 2, 13, '16/32/64', '64', 3200, '2G/3G/3G+/4G(LTE)', 'HD 1080p (1920x1080)', '2160p@30fps /  1080p@60fps', 'samsunggalaxynote3', 2, 5, 5, 1, '2015-02-03', '1920x1080', '');
