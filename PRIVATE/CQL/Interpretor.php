...
class Interpreter {
    ...
    public function interpret($stringIn) {
        ...
        if ('compared' == $arrayIn[0]) {
            if ('compare' == $arrayIn[1]) {
...
writeln('test 1 - invalid request missing "compared"');
writeln($interpreter->interpret('author 1'));
writeln('');

writeln('test 2 - valid book author request');
writeln($interpreter->interpret('compared compare 1'));
writeln('');

writeln('test 3 - valid book title request');
writeln($interpreter->interpret('compared get sm 2'));
writeln('');
